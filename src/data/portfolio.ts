...
export const portfolioItems: PortfolioItem[] = [
  ...
  },
  {
    ...
    description:
      'More than one in four physicians (26%) report that prior authorization has led to a serious adverse event for a patient in their care, and the HHS Inspector General found 13% of sampled Medicare Advantage denials were for services that actually met coverage rules. PACCA answers with a five-agent clinical platform whose seven deterministic pre-flight gates and three governance gates override model confidence on experimental treatments, rare conditions, and conflicting guidelines — every ambiguous case routed to a Medical Director. Pre-production; synthetic cases only.',
    fullDescription:
      'Multi-agent LLM system automating healthcare prior authorization workflows. Built with Claude API, FastAPI, React, and ChromaDB RAG for evidence-based clinical decision support with human oversight. Targets the administrative load the AMA documents annually — roughly 13 physician-and-staff hours per week across about 40 requests per physician, with 40% of practices employing staff who do nothing else — through workflow automation that keeps a human on every ambiguous case. Features multi-agent orchestration, RAG-powered guideline retrieval, explainable decision reasoning, seven deterministic pre-flight gates plus three P-3/P-4/P-5 governance gates and runtime short-circuits, and audit-grade observability. Prior-authorization administrative spending is estimated at roughly $35B a year across payers and providers, about a third of it judged savable within three years through standardization and automation. These problem-statement figures were corrected against primary sources in September 2026; earlier versions of this card carried higher estimates that conflated prior authorization with adjacent categories of utilization management, and the correction record is in the SDD v3.0 revision history. The engineering practices here are production-grade; the deployment is not. PACCA is pre-production: not HIPAA-validated, no Business Associate Agreements in place, and every clinical case in the repository is synthetic. Treat it as a reference architecture, not a turnkey product.',
    category: 'github',
  ...
  },
  {
    ...
    description:
      'Closes the gap between what ISO/IEC 42001, ISO/IEC 42005, and NIST AI RMF require and what teams must actually produce to deploy agentic AI safely: seven governance artifacts, a nine-phase lifecycle, and a five-class delegation taxonomy — now with a Responsible-AI approver and a consequential-decision flag. v3.0 adds agent-identity, ISO/IEC 42005 impact-assessment, and workforce-impact artifacts, and specifies mitigations for cascading-agent-failure (ASI08) and human-trust-exploitation (ASI09) threats. Presented as design propositions and implementation guidance — explicitly not yet empirically validated.',
    fullDescription:
      "CRISP-AG (v3.0, September 2026) is a practitioner white paper proposing an artifact-centered implementation framework for enterprise agentic AI governance. It addresses the gap between management-system standards (ISO/IEC 42001, ISO/IEC 42005) and risk frameworks (NIST AI RMF) and the operational artifacts teams must actually produce to deploy multi-step, tool-calling, and multi-agent LLM systems safely. CRISP-AG extends CRISP-DM's lifecycle with three agentic-specific phases — Operational Context Assembly, Trust/Governance/Risk Architecture, and Iterative Refinement and Scale — yielding a nine-phase governed lifecycle with explicit decision gates. It formalizes seven core artifacts under-specified in current AI governance and MLOps practice: (1) Delegation Authority Scoping (DAS), a five-class autonomy taxonomy with named cross-functional approval and Legal review calibrated per delegation class, now with a Responsible-AI approver and an explicit consequential-decision flag grounded in OMB M-25-21; (2) Contractor Access Governance (CAG), an explicit Contractor Access Profile that closes the agent-mediated data-access gap in mixed FTE/contractor/vendor workforces; (3) Orchestration Contracts, formal per-sub-agent specifications binding implementation, testing, and audit, now with pipeline-level failure containment — per-hop validation, a blast-radius budget, and a halt-the-line rule — that addresses cascading agent failures (OWASP ASI08); (4) Capability Frontier Classification, a threshold-framed taxonomy rendered as a horizontal suitability spectrum; (5) an Agent Identity and Registry Record binding each non-human principal to its credential, accountable human, and delegated scope (OWASP ASI03); (6) an AI System Impact Assessment aligned to ISO/IEC 42005:2025 and usable as the EU AI Act Fundamental Rights Impact Assessment; and (7) a Workflow and Workforce Impact Record tying task allocation and reviewer capacity to the delegation artifacts. The framework adds first-class output gating as a security defense, reviewer-behavior metrics that answer human-agent trust exploitation (OWASP ASI09), coverage-based adversarial test minimums, per-class compressed lifecycle tracks, formula-based ROI guidance with explicit non-summing rationale, and an Appendix B Standards Mapping Matrix aligning every phase and artifact to ISO/IEC 42001, ISO/IEC 42005, NIST AI RMF, the EU AI Act, OMB M-25-21, and OWASP's LLM and Agentic (ASI) Top-10 controls. Strongest fit: Class 2–3 ReAct and orchestrated multi-agent enterprise systems with tool access; Class 4 code-executing agents require additional sandboxing and red-team validation. Positioned as design propositions and implementation guidance — not yet empirically validated — with an explicit validation agenda for multi-site case studies.",
    category: 'whitepaper',
    tags: ['AI Governance', 'Agentic AI', 'ISO 42001', 'ISO 42005', 'NIST AI RMF', 'Multi-Agent', 'Enterprise'],
    link: 'https://docs.google.com/document/d/1DM5ydYzJuo6qM0QgSlvxrAHmhon9sHbZ/edit?usp=sharing',
    metrics: '7 Artifacts · 9-Phase Lifecycle',
    featured: true,
  },
  {
    id: 'whitepaper-3',
    ...
    metrics: '175 REQ-IDs · Audited Against the Build',
    featured: true,
  },
  {
