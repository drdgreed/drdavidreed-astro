...
The system is open-source, runs on synthetic data only, and lives at [github.com/Chaos-6/pacca](https://github.com/Chaos-6/pacca). There is no PHI involved at any point in this work — every case in the eval suite is generated, and the methodology is published precisely so other teams in regulated domains can adopt, fork, or critique it.
...
If you're working on agentic AI in regulated domains — healthcare, finance, legal — I would genuinely value a critical read. The repo is at [github.com/Chaos-6/pacca](https://github.com/Chaos-6/pacca); the four open documents are reachable from the README. Skeptical engagement is the most useful kind.
